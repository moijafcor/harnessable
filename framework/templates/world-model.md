...
# ║  SECURITY NOTICE                             ║
# ║                                              ║
# ║  This file contains infrastructure topology  ║
# ║  and operational data specific to your       ║
# ║  project.                                    ║
# ║                                              ║
# ║  If your repository is PUBLIC:               ║
# ║    - Add WORLD_MODEL.md to .gitignore        ║
# ║    - Never commit real IPs, node names,      ║
# ║      service names, or client topology       ║
# ║    - Keep this file in a PRIVATE repo        ║
# ║      alongside your codebase                 ║
# ║                                              ║
# ║  Real infrastructure data in a public repo   ║
...
# Add entries after every incident that reveals a
# new pattern. Format:
#
